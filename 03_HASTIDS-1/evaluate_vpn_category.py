...
train_loader = Dataloader(X_train, Y_train, 7000, shuffle=False)
...
model = load_model.load_HASTIDS1(600, num_classes)
...
y_prob_train = model.predict(train_loader)
y_prob_train = y_prob_train
y_true_train = np.argmax(Y_train, axis=1)

plot.plot_multiclass_reliability_diagram(
    y_true_train, y_prob_train, f"HAST1_{task}.png", task
)
